...
st.image("Nobel.png", caption="It was created by the Swedish inventor Alfred Nobel through his will in 1895.")
...
nobel =  pd.read_csv('df_final.csv', encoding='latin-1')
X = nobel.Text
y = nobel.Label
